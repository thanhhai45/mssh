...
export namespace transport {
	...
	export class ShellEnvironmentVariable {
	    name: string;
	    value: string;
	    masked: boolean;
	    interesting: boolean;
	    ...
	    static createFrom(source: any = {}) {
	        return new ShellEnvironmentVariable(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.interesting = source["interesting"];
	    }
	}
	export class ShellEnvironmentReport {
	    shell: string;
	    durationMs: number;
	    error: string;
	    ...
	    static createFrom(source: any = {}) {
	        return new ShellEnvironmentReport(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.variables = this.convertValues(source["variables"], ShellEnvironmentVariable);
	    }
