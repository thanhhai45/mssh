...
export function GetShellEnvironment():Promise<transport.ShellEnvironmentReport>;
...
export function ReloadShellEnvironment():Promise<transport.ShellEnvironmentReport>;
